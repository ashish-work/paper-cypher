...
config.set_main_option("sqlalchemy.url", "postgresql://postgres:postgres@localhost/postgres")#os.environ["DATABASE_URL"])
...
from app.models.domains.users import Users
